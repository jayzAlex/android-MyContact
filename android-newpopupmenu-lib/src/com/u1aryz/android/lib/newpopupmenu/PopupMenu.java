...
//        mPopupWindow.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.panel_background));
    ...
    public void setHeaderTitle(int titleResid) {
        mHeaderTitleView.setText(mContext.getResources().getString(titleResid));
        mHeaderTitleView.setVisibility(View.VISIBLE);
        mHeaderTitleView.requestFocus();
    }    
    ...
    private class MenuItemAdapter extends ArrayAdapter<MenuItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.icon = (ImageView) convertView.findViewById(R.id.iv_menu_list_item_icon);
                holder.title = (TextView) convertView.findViewById(R.id.tv_menu_list_item_title);
