...
public class HomeContactActivity2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		titleLayout = (LinearLayout) this.acbuwaPage.findViewById(R.id.title_layout); 
		title = (TextView) this.acbuwaPage.findViewById(R.id.title);
		...
		menuBtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				scrollView.clickMenuBtn(HomeContactActivity2.this);
			}
		});
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if(keyCode == KeyEvent.KEYCODE_BACK){
			if(MenuHorizontalScrollView.menuOut == true)
				this.scrollView.clickMenuBtn(HomeContactActivity2.this);
			else
				this.finish();
			return true;
		}
...
//					}
	...
	private void setAdapter(List<ContactBean> list) {
		...
		alpha.init(HomeContactActivity2.this);
		...
		personList.setOnScrollListener(new OnScrollListener() {
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				if (firstVisibleItem != lastFirstVisibleItem) {
					...
					title.setText(adapter.charAt(section));
				}
		...
		new AlertDialog.Builder(this).setTitle(cb.getDisplayName()).setItems(arg,
			...
			public void onClick(DialogInterface dialog, int which){
				...
				case 1://发短息
					...
					BaseIntentUtil.intentSysDefault(HomeContactActivity2.this, MessageBoxList.class, map);
					break;
	...
	private void showDelete(final int contactsID, final int position) {
		...
		.setPositiveButton("确定", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				Uri lookupUri = ContactsContract.Contacts.getLookupUri(HomeContactActivity2.this.getContentResolver(), deleteUri);
				if(lookupUri != Uri.EMPTY){
					HomeContactActivity2.this.getContentResolver().delete(deleteUri, null, null);
				}
				adapter.remove(position);
				adapter.notifyDataSetChanged();
				Toast.makeText(HomeContactActivity2.this, "该联系人已经被删除.", Toast.LENGTH_SHORT).show();
			}
		})
...
//				}
	...
	private HomeContactActivity2.BaseReceiver1 receiver1 = null;
	/**
	 * 打开接收器
	 */
	private void startReceiver1() {
		if(null==receiver1){
			...
			receiver1 = new HomeContactActivity2.BaseReceiver1();
