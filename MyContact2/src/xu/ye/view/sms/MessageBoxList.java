...
import xu.ye.view.adapter.TextWatcherAdapter;
...
public class MessageBoxList extends FragmentActivity implements EmojiconGridFragment.OnEmojiconClickedListener, EmojiconsFragment.OnEmojiconBackspaceClickedListener {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		emojicons_layout = (LinearLayout) findViewById(R.id.emojicons_layout);
		duomeiti = (Button)findViewById(R.id.duomeiti);
		duomeiti.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if(emojiconsLayoutVisible == false)
					setEmojiconsLayoutVisibility(true);
				else
					setEmojiconsLayoutVisibility(false);
				emojiconsLayoutVisible = !emojiconsLayoutVisible;
			}
		});
		neirong = (EditText) findViewById(R.id.neirong);
//        mTxtEmojicon = (TextView) findViewById(R.id.txtEmojicon);
        neirong.addTextChangedListener(new TextWatcherAdapter() {
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
//                mTxtEmojicon.setText(s);
            	Log.i("mTxtEmojicon", s + "");
            }
        });		
	...
	private void doQuery(String thread){
	...
	private boolean emojiconsLayoutVisible = false;
	public void setEmojiconsLayoutVisibility(boolean visible) {
		if (emojicons_layout != null) {
			emojicons_layout.setVisibility(visible ? View.VISIBLE : View.GONE);
		}
	}

    @Override
    public void onEmojiconClicked(Emojicon emojicon) {
        EmojiconsFragment.input(neirong, emojicon);
    }

    @Override
    public void onEmojiconBackspaceClicked(View v) {
        EmojiconsFragment.backspace(neirong);
    }	
