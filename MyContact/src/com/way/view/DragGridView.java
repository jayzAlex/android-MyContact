...
public class DragGridView extends ViewGroup implements View.OnTouchListener,
	...
	protected void animateDragged() {
		...
		int x = getCoorFromIndex(dragged).x + childSize / 2, y = getCoorFromIndex(dragged).y
				+ childSize / 2;
		int l = x - (3 * childSize / 4), t = y - (3 * childSize / 4);
		LayoutParams contentLayoutParams = (ViewGroup.LayoutParams) v.getLayoutParams(); 
		contentLayoutParams.width = childSize * 3 / 2;
		contentLayoutParams.height = childSize * 3 / 2;
